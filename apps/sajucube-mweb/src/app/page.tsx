...
export default async function Home({ searchParams }: HomeProps) {
  ...
  return (
    <main className="flex-1 flex flex-col overflow-hidden bg-[linear-gradient(180deg,#f2ece2_0%,#fbfaf7_34%,#efe8dc_100%)] px-2 py-2 text-stone-900 md:px-5 md:py-6 relative z-0">
